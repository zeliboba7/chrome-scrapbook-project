 ...
 */
	...
	var defaults = {
		...
		, maxRows: 10000                 // specify the maximum rows in a column
	...
	$.mcDropDownMenu = function(el, list, options){
		...
		console.log('marking li.. with mc_root class');
		//$list.find("> li").each(function(i){console.log(this)});
